...
class MyLeNet5(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_1 = py_nndct.nn.Conv2d(in_channels=1, out_channels=4, kernel_size=[5, 5], stride=[1, 1], padding=[2, 2], dilation=[1, 1], groups=1, bias=True) #MyLeNet5::MyLeNet5/Conv2d[c1]/input.3
        ...
        self.module_4 = py_nndct.nn.Conv2d(in_channels=4, out_channels=16, kernel_size=[5, 5], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #MyLeNet5::MyLeNet5/Conv2d[c3]/input.7
        ...
        self.module_7 = py_nndct.nn.Conv2d(in_channels=16, out_channels=96, kernel_size=[5, 5], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #MyLeNet5::MyLeNet5/Conv2d[c5]/308
        self.module_8 = py_nndct.nn.Module('nndct_flatten') #MyLeNet5::MyLeNet5/Flatten[flatten]/311
        self.module_9 = py_nndct.nn.Linear(in_features=96, out_features=84, bias=True) #MyLeNet5::MyLeNet5/Linear[f6]/312
