...
class MyLeNet5(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_1 = py_nndct.nn.Conv2d(in_channels=1, out_channels=6, kernel_size=[5, 5], stride=[1, 1], padding=[2, 2], dilation=[1, 1], groups=1, bias=True) #MyLeNet5::MyLeNet5/Conv2d[c1]/242
        self.module_2 = py_nndct.nn.Sigmoid() #MyLeNet5::MyLeNet5/Sigmoid[Sigmoid]/243
        self.module_3 = py_nndct.nn.AvgPool2d(kernel_size=[2, 2], stride=[2, 2], padding=[0, 0], ceil_mode=False, count_include_pad=True) #MyLeNet5::MyLeNet5/AvgPool2d[s2]/input.3
        self.module_4 = py_nndct.nn.Conv2d(in_channels=6, out_channels=16, kernel_size=[5, 5], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #MyLeNet5::MyLeNet5/Conv2d[c3]/275
        self.module_5 = py_nndct.nn.Sigmoid() #MyLeNet5::MyLeNet5/Sigmoid[Sigmoid]/276
